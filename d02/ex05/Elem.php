...
//   private function isContentValid() {
//     $thisContent = $this->content["content"];
//     foreach ($thisContent as $childElement) {
//         if ($childElement instanceof Elem) {
//             $isValidElement = $this->isElementValid($childElement);
//             if ($isValidElement) {
//                 if (!$childElement->isContentValid()) {
//                     return false;
//                 };
//             } else {
//                 return false;
...
//   private function isElementValid($childNode) {
//     $thisElement = $this->content["tagName"];
//     $thisContent = $this->content["content"];

//     var_dump($childNode->getElementDescription()["tagName"]);
