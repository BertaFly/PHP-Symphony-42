...
class DefaultController extends Controller
{
    ...
    {
        $cmd_string = "php ../bin/console doctrine:schema:update --force";
        $result = array();
        ...
        if ( !empty($result) && ($result[0] == "Nothing to update - your database is already in sync with the current entity metadata." || $result[1] == "Database schema updated successfully! \"1\" query was executed") ){
            ...
            return $this->render('@E01/Default/index.html.twig', array("content" => $content));
        }
        return $this->render('@E01/Default:index.html.twig', array("content" => ""));
    }
